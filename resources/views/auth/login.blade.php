...
<body class="flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg text-center max-w-md w-full mx-auto">
        ...
        <form method="POST" action="/auth/login">
            ...
            <button
                class="bg-blue-500 text-white w-full py-2 rounded-lg hover:bg-blue-600 transition duration-300">Continue</button>
        </form>
        <br>
        <a href="/" class="text-blue-500 hover:underline">Back Home
        </a>
    </div>
</body>
